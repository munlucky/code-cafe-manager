...
import { Cafe, Order, OrderStatus, WorkflowDefinition } from '../types';
          ...
          <>
            ...
            <div className="flex-1 bg-terminal-bg p-8 overflow-y-auto terminal-scroll font-mono text-sm relative shadow-inner">
               ...
               <div className="space-y-4 max-w-5xl">
                 ...
                 {activeOrder.status === OrderStatus.RUNNING && (
            ...
            {activeOrder.status === OrderStatus.WAITING_INPUT ? (
...
const StatusBadge = ({ status, size = 'sm' }: { status: OrderStatus, size?: 'sm' | 'lg' }) => {
  ...
  switch (status) {
    ...
    case OrderStatus.WAITING_INPUT:
