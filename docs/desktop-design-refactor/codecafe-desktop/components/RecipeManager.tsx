...
import { Recipe, Skill, StageConfig } from '../types';
...
export const RecipeManager: React.FC<RecipeManagerProps> = ({ recipes, skills, onAddRecipe, onUpdateRecipe, onDeleteRecipe }) => {
