...
export function OrderModal({
  ...
  return (
    <Dialog
      ...
      size="xlarge"
      layout="flex"
      contentClassName="w-[90vw] h-[80vh] max-h-[800px] bg-cafe-950 border-cafe-700 p-0 gap-0"
    >
      {/* Custom Header with Tabs */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-cafe-800 bg-cafe-900 shrink-0">
        <div>
          <h2 className="text-lg font-bold text-cafe-100 flex items-center gap-2">
          ...
          <p className="text-sm text-cafe-500 font-mono mt-1">
            {order.id}
          </p>
        </div>
      ...
      {/* Content Area */}
      <div className="flex-1 overflow-hidden bg-terminal-bg relative flex flex-col min-h-0">
        {currentTab === 'summary' && (
          <>
            {/* Summary Section */}
