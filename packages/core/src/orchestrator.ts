 ...
 *
 * @deprecated The Orchestrator class is part of a legacy architecture and is being replaced by more modular components. For order execution, please migrate to ExecutionFacade from @codecafe/orchestrator.
